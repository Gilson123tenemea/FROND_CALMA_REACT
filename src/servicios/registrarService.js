...
export const registrarPaciente = async (payload) => {
  try {
    const response = await axios.post('http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/registro/paciente', payload);
...
export const registrarAspirante = async (payload) => {
  try {
    ...
    const response = await axios.post('http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/registro/aspirante', payload);
    return response.data;  // devuelve lo que retorna el backend
  } catch (error) {
...
export const registrarContratante = async (payload) => {
  try {
    const response = await axios.post('http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/registro/contratante', payload);
...
export const obtenerDetalleAspirante = async (idAspirante) => {
  try {
    const response = await axios.get(`http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/registro/aspirante/detalle/${idAspirante}`);
