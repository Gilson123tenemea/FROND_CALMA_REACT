...
const ModuloContratante = () => {
  ...
  const cargarDatosUsuarioActual = async (contratistaId) => {
    try {
      ...
      const response = await axios.get(`http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/usuarios/${contratistaId}`);
  ...
  const handleAbrirPanelUsuarios = async () => {
    ...
    try {
      ...
      const response = await axios.get(`http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/postulacion/contratista/${contratanteId}/aspirantes-para-chat`);
  ...
  const handleAbrirNotificaciones = async () => {
    ...
    try {
      ...
      await axios.put(`http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/notificaciones/contratante/marcar-leidas/${contratanteId}`);
      const response = await axios.get(`http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/notificaciones/contratante/${contratanteId}`);
