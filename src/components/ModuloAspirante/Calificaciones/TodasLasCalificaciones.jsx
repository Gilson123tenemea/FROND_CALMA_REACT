...
const TodasLasCalificaciones = () => {
  ...
  const obtenerUserId = async (idAspirante) => {
    try {
      ...
      const response = await fetch(`http://softwave.online:8090/api/usuarios/buscar_aspirante/${idAspirante}`);
  ...
  const cargarCalificaciones = async () => {
    try {
      ...
      const endpoint = `http://softwave.online:8090/api/calificaciones/aspirante/${currentAspiranteId}`;
  ...
  const cargarResumen = async () => {
    try {
      ...
      const endpoint = `http://softwave.online:8090/api/calificaciones/aspirante/${currentAspiranteId}/resumen`;
      const respuesta = await fetch(endpoint);
