...
const HeaderAspirante = ({
  ...
  const obtenerAspiranteIdDesdeUserId = async (idUsuario) => {
    try {
      ...
      const response = await axios.get('http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/calificaciones/debug/relaciones');
  ...
  const cargarDatosUsuario = async (idUsuario) => {
    ...
    try {
      ...
      try {
        const response = await axios.get(`http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/usuarios/${idUsuario}`);
        if (response.data) {
          setDatosUsuario({
  ...
  const cargarNotificacionesNoLeidas = async (idAspirante) => {
    ...
    try {
      ...
      const response = await axios.get(`http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/notificaciones/aspirante/noleidas/${idAspirante}`);
  ...
  const handleAbrirPanelUsuarios = async () => {
    ...
    const endpoints = [
      `http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/postulacion/aspirante/${aspiranteId}/contratantes-para-chat`,
      `http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/postulacion/aspirante/${aspiranteId}/contratistas-para-chat`,
      `http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/chat/aspirante/${aspiranteId}/contactos`
    ];
  ...
  const handleAbrirNotificaciones = async () => {
    ...
    try {
      ...
      await axios.put(`http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/notificaciones/aspirante/marcar-leidas/${aspiranteId}`);
      const response = await axios.get(`http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/notificaciones/aspirante/${aspiranteId}`);
