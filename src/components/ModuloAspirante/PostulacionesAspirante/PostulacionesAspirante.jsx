...
const PostulacionesAspirante = () => {
  ...
  const obtenerUserId = async (idAspirante) => {
    try {
      ...
      const response = await axios.get(`http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/usuarios/buscar_aspirante/${idAspirante}`);
  ...
  const fetchData = async () => {
    try {
      ...
      const postulacionesResponse = await axios.get(`http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/realizar/aspirante/${currentAspiranteId}`);
