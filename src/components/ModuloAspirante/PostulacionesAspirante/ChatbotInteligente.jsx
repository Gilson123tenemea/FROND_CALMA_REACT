...
const ChatbotInteligente = ({ aspiranteId, isOpen, onToggle }) => {
    ...
    const cargarPacientesDisponibles = async () => {
        try {
            ...
            const response = await axios.get(`http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/realizar/aspirante/${aspiranteId}`);
    ...
    const enviarMensaje = async () => {
        ...
        try {
            ...
            if (tipoConsulta === 'general') {
                ...
                const response = await axios.post('http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/chatbot/preguntar', {
                ...
                const response = await axios.post('http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/chatbot/recomendaciones-cuidado', {
                ...
                const response = await axios.post('http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/chatbot/evaluacion-riesgos', {
                    idPaciente: pacienteSeleccionado.id
                });
                respuesta = response.data.respuesta;
            } else {
