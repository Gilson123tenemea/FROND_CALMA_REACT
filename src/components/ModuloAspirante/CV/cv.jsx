...
import { FaEdit, FaGlobe, FaLanguage } from "react-icons/fa";
import './cv.css';
...
const CVForm = () => {
  ...
  const handleVolver = () => {
    navigate(`/ModuloAspirante`, { state: { userId: aspiranteId } });
  };
          ...
          <div className="registro-card">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="button-group">
                <button type="submit" className="submit-btn">Guardar y Continuar</button>
                <button type="button" className="back-btn" onClick={handleVolver}>Volver</button>
              </div>
            </form>
          </div>
        </div>
