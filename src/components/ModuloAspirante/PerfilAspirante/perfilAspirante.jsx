...
const PerfilAspirante = () => {
  ...
  const BASE_URL = "http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/registro/";
      ...
      if (response.success && response.aspirante) {
        ...
        const datosFormateados = {
          ...
          foto: aspirante.foto && aspirante.foto.trim() !== ""
            ? `http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/registro/${aspirante.foto}`
            : null
        };
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`http://backend-alb-283290471.us-east-2.elb.amazonaws.com:8090/api/registro/aspirante/${aspiranteId}`, {
        method: 'PUT',
