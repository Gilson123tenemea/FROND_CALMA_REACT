...
const Registro = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validar que se haya seleccionado si es representante o no
      ...
      <div className="registro-container">
        <div className="registro-card">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="input-group">
              <label><FaQuestionCircle className="input-icon" /> ¿Usted es representante de una empresa?</label>
            ...
            {/* Campos condicionales para aspirante (no representante) */}
            {formData.esRepresentante === false && (
              <>
